...
<p>It's simple: include one of the three files (master_redone.js, master.min.js, or expiremental.js) on your website, and make sure you have the form/table HTML files found here.</p>
